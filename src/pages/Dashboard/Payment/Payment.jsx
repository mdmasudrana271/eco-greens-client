...
const Payment = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Eco Greens | Payment</title>
      </Helmet>
      <section className="py-6 dark:bg-gray-100 dark:text-gray-900">
        ...
        >
          ...
          >
            ...
            <button
              type="submit"
              className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 bg-green-400 text-white focus:ring-green-600 hover:ring-green-600"
            >
              Submit
            </button>
          </form>
